        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <button class="btn btn-success"><h1 class="">Título <?php echo "".$titulo.""; ?></h1></button><br><br><br>
                <p class="card-text">Propietario: <?php  echo "<b>".$owner."</b><br>Cantidad de Acciones: <b>".$cont."</b>"; ?></p>
        ...
        <div class="col-lg-8">
           <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                ...
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link active"><i class="icon-note"></i> <span class="hidden-xs">DATOS DE TRANSFERENCIA</span></a>
                </li>
                <li class="nav-item">
                    <span class="hidden-xs"></span>
                </li>
            ...
            <div class="tab-content p-3">
                ...
                <div class="tab-pane active" id="edit">
                    <form action="tdone.php" method="POST">
                        
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Datos del Usuario</label>
                            <div class="col-lg-9">
                              <select class="custom-select" name="userdata">
                                <option value=""></option>
                              <?php
                                $bcc = mysqli_query($conexion, "SELECT * FROM login");
                                  while ($b = mysqli_fetch_assoc($bcc)) {
                                    echo '
                                            <option name="userdata" value="'.$b['OWNER'].'">'.$b['OWNER'].'  -  '.$b['NOMBRES'].' '.$b['APELLIDOS'].'</option>';
                                  }
                              ?>
                              </select>
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Acción</label>
                            <div class="col-lg-9">
                              <select class="custom-select" name="n_accion">
                                <option value=""></option>
                              <?php
                                $acc = mysqli_query($conexion, "SELECT * FROM accion");
                                $sql = mysqli_query($conexion, "SELECT * FROM titulo WHERE T_NUM = '".$titulo."'");
                                  while ($r = mysqli_fetch_assoc($sql)) {
                                    while ($ac = mysqli_fetch_assoc($acc)) {
                                      if ($ac['T_NUM']==$titulo) {
                                        echo '
                                            <option name="n_accion" value="'.$ac['ID'].'">Acción '.$ac['ID'].'</option>';
                                      }
                                    }
                                  }
                              ?>
