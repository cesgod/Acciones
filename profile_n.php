        ...
        <div class="col-lg-8">
           ...
           <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                ...
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link"><i class="icon-note"></i> <span class="hidden-xs">NUEVO</span></a>
                </li>
                <li class="nav-item">
                     <span class="hidden-xs"></span>
                </li>
            ...
            <div class="tab-content p-3 container1">
                ...
                <div class="tab-pane active" id="edit">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">C.I.:</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <input class="form-control" type="text" name="ruc" placeholder="Opcional">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Celular</label>
                            <div class="col-lg-9">
                              <input class="form-control" type="number" name="celular" placeholder="09xx xxx xxx" minlength="10" maxlength="10">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                              <input class="form-control" type="email" name="email" placeholder="xxxxxx@xxx.xxx">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                              <?php
                                ...
                                $sql = mysqli_query($conexion, "SELECT * FROM titulo WHERE T_NUM = '".$titulo."'");
                                  ...
                                  echo '<input class="form-control" type="number" value="" name="n_accion" placeholder="Limite ('.$accq.')" min="1" max="'.$accq.'" required>';
                              ?>
                            </div>
                        </div>
