           ...
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
               <img src="assets/images/logo_clip.png"  style="margin: auto;display: block;">
                <div class="text-center"><button class="btn btn-light"><h1 class="">TRANSFERENCIA</h1></button></div><br><br>
                <form action="transfered.php" method="POST">
                  <select class="custom-select myselect" name="userdata"  id="myselect" style="width: 300px; margin: auto;display: block;">
                                  <option value=""></option>
